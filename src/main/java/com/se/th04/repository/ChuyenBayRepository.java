...
//	18. Với mỗi ga có chuyến bay xuất phát từ đó cho biết có bao nhiêu chuyến bay khởi hành từ ga đó.
	@Query(value = "select GaDi, count(*) as SoChuyenBay from chuyenbay group by GaDi", nativeQuery = true)
...
//	21. Với mỗi địa điểm xuất phát cho biết có bao nhiêu chuyến bay có thể khởi hành trước 12:00.
	@Query(value = "select GaDi, count(*) as soluong from chuyenbay where GioDi<'12:00:00' group by GaDi", nativeQuery = true)
